...
import * as import12 from './header.component.ngfactory';
...
var _View_AppComponent0 = (function (_super) {
    ...
    _View_AppComponent0.prototype.createInternal = function (rootSelector) {
        ...
        var compView_2 = import12.viewFactory_HeaderComponent0(this.viewUtils, this.injector(2), this._appEl_2);
        ...
        this._RouterOutlet_6_5 = new import11.RouterOutlet(this.parentInjector.get(import15.RouterOutletMap), this._appEl_6.vcRef, this.parentInjector.get(import16.ComponentFactoryResolver), null);
    ...
    _View_AppComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        if (((this.numberOfChecks === 0) && !throwOnChange)) {
            this._HeaderComponent_2_4.ngOnInit();
        }
...
export function viewFactory_AppComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AppComponent === null)) {
        (renderType_AppComponent = viewUtils.createRenderComponentType('C:/Users/Nathan/Documents/JavaScript/BookTrader/assets/app/app.component.html', 0, import8.ViewEncapsulation.None, styles_AppComponent, {}));
    }
